<template>
  <div>
    <b-row>
      <b-col cols="12">
        <b-card :header="'<strong>Gestionar Mesas</strong> (' + totalFilas + ')'" tag="article" class="m-3 mt-3">
      ...
      this.$alertify
        .confirmWithTitle(
          ...
          function() {
            ...
            self.$http.post("ws/mesa/", self.objeto).then(resp => {
                self.$loader.close();
                self.listar();
      ...
      this.$alertify
        .confirmWithTitle(
          ...
          function() {
            ...
            self.$http.put("ws/mesa/", self.objeto).then(resp => {
                self.$loader.close();
                self.listar();
                self.$toast.success(resp.data.mensaje);
              })
      ...
      this.$alertify
        .confirmWithTitle(
          ...
          function() {
            ...
            self.$http.delete("ws/mesa/", {params: {id: self.objeto.id, token: token}}).then(resp => {
                self.$loader.close();
                self.listar();
                self.$toast.success(resp.data.mensaje);
              })
