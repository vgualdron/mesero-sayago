<template>
  <div>
    <b-row>
      <b-col cols="12">
        <b-card :header="'<strong>Gestionar Tipo Producto</strong> (' + totalFilas + ')'" tag="article" class="m-3 mt-3">
      ...
      this.$alertify
        .confirmWithTitle(
          ...
          function() {
            ...
            self.$http.post("ws/tipoproducto/", self.objeto).then(resp => {
                self.$loader.close();
                self.listar();
      ...
      this.$alertify
        .confirmWithTitle(
          ...
          function() {
            ...
            self.$http.put("ws/tipoproducto/", self.objeto).then(resp => {
                self.$loader.close();
                self.listar();
                self.$toast.success(resp.data.mensaje);
              })
      ...
      this.$alertify
        .confirmWithTitle(
          ...
          function() {
            ...
            self.$http.delete("ws/tipoproducto/", {params: {id: self.objeto.id, token: token}}).then(resp => {
                self.$loader.close();
                self.listar();
                self.$toast.success(resp.data.mensaje);
              })
